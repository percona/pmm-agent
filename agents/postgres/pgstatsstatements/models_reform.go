...
var pgStatDatabaseView = &pgStatDatabaseViewType{
	s: parse.StructInfo{Type: "pgStatDatabase", SQLSchema: "pg_catalog", SQLName: "pg_stat_database", Fields: []parse.FieldInfo{{Name: "Datid", Type: "[]uint8", Column: "datid"}, {Name: "Datname", Type: "*string", Column: "datname"}}, PKFieldIndex: -1},
...
var pgUserView = &pgUserViewType{
	s: parse.StructInfo{Type: "pgUser", SQLSchema: "pg_catalog", SQLName: "pg_user", Fields: []parse.FieldInfo{{Name: "UserId", Type: "[]uint8", Column: "usesysid"}, {Name: "Username", Type: "*string", Column: "usename"}}, PKFieldIndex: -1},
	z: new(pgUser).Values(),
}
