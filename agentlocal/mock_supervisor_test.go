...
import (
	...
	supervisor "github.com/percona/pmm-agent/agents/supervisor"
)
...
func (_m *mockSupervisor) AgentsLogs() []*supervisor.AgentLogs {
	ret := _m.Called()

	var r0 []*supervisor.AgentLogs
	if rf, ok := ret.Get(0).(func() []*supervisor.AgentLogs); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*supervisor.AgentLogs)
		}
	}
